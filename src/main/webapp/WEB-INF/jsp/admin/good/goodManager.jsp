            ...
            <form class="layui-form" style="width:90%;" id="dataFrm" lay-filter="dataFrm">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="text" name="goodName" lay-verify="required" autocomplete="off"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="goodNum" lay-verify="required" autocomplete="off" placeholder="请输入商品数量"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script>
    layui.use(['form', 'table', 'layer'], function () {
        ...
        var tableIns = table.render({
            ...
            elem: '#currentTableId',
            //异步接口
            url: '${pageContext.request.contextPath}/admin/good/list',
            //工具栏id
            //若需要“列显示隐藏”、“导出”、“打印”等功能，则必须开启该参数
            toolbar: '#toolbarDemo',
            //设置表头
            cols: [[
                {field: 'id', width: 120, title: "商品编号", align: 'center'},
                {field: 'goodName', minWidth: 120, title: '商品名称', align: 'center'},
                {field: 'goodNum', minWidth: 150, title: '商品数量', align: 'center'},
                {field: 'remark', minWidth: 120, title: '商品描述', align: 'center'},
        ...
        function deleteById(data) {
            layer.confirm('你确定删除【' + data.goodName + '】吗', {icon: 3, title: '提示'}, function (index) {
                //do something
                $.post("/admin/good/deleteById", {"id": data.id}, function (result) {
                    if (result.success) {
                        //刷新数据
                        tableIns.reload();
                    }
